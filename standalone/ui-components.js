(() => {
  ...
  const docs = {
    ...
    select: { title: "Select", summary: "用於從伺服器提供的選項集合選擇一個值。", razor: `<ui-select asp-for="Country"
           label="國家／地區"
    ...
    radio: { title: "Radio", summary: "同一個欄位提供多個互斥選項。", razor: `<ui-radio asp-for="PreferredContact" value="Email" label="電子郵件" />
<ui-radio asp-for="PreferredContact" value="Phone" label="電話" />`, data: `<p>所有 Radio 使用相同的 <code>asp-for</code>，每個選項使用不同 <code>value</code>。</p><p>例如：<code>public string? PreferredContact { get; set; }</code>。</p>` },
    button: { title: "Button", summary: "提交表單或觸發頁面動作的按鈕。", razor: `<ui-button type="submit"
    ...
    "time-picker": { title: "時間選擇器", summary: "翻頁時鐘式的純時間輸入，支援 12／24 小時制與 AM／PM。", razor: `<ui-time-picker asp-for="SelectedTime"
                label="開始時間"
    ...
    "date-range-picker": { title: "日期區間", summary: "一次選擇起日與迄日；端點與中間區間可使用不同顏色。", razor: `<ui-date-range-picker asp-for-start="StartDate"
                      asp-for-end="EndDate"
                      label="住宿日期"
